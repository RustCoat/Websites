    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file, 38, 4, 1210);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 57, 3, 2063);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h10 = element("h1");
    			h10.textContent = "Best website ever!";
    			t1 = space();
    			h2 = element("h2");
    			t2 = text(t2_value);
    			t3 = space();
    			...
    			button3.textContent = "...";
    			add_location(h10, file, 27, 2, 634);
    			add_location(h2, file, 28, 2, 664);
    			attr_dev(div0, "class", "svelte-ctxvck");
    			...
    			add_location(rect0, file, 32, 3, 776);
    			attr_dev(rect1, "x", "1");
    			attr_dev(rect1, "y", "2");
    			...
    			add_location(rect1, file, 33, 3, 894);
    			attr_dev(svg0, "viewBox", "0 0 100 100");
    			attr_dev(svg0, "style", "width:25%; height=25%");
    			add_location(svg0, file, 31, 2, 715);
    			set_style(circle0, "stroke", "white");
    			set_style(circle0, "fill", "none");
    			attr_dev(circle0, "r", "48");
    			add_location(circle0, file, 36, 3, 1089);
    			...
    			add_location(line0, file, 40, 3, 1311);
    			...
    			add_location(line1, file, 41, 3, 1401);
    			attr_dev(svg1, "viewBox", "-50 -50 100 100");
    			attr_dev(svg1, "style", "width:25%; height=25%");
    			add_location(svg1, file, 35, 2, 1024);
    			set_style(circle1, "stroke", "white");
    			set_style(circle1, "fill", "none");
    			attr_dev(circle1, "r", "48");
    			add_location(circle1, file, 44, 3, 1563);
    			attr_dev(line2, "y1", "-45");
    			attr_dev(line2, "y2", "-48");
    			set_style(line2, "stroke", "white");
    			add_location(line2, file, 46, 4, 1665);
    			attr_dev(text0, "y", "-30");
    			attr_dev(text0, "x", "-4.5");
    			set_style(text0, "fill", "white");
    			attr_dev(text0, "transform", text0_transform_value = "rotate(" + /*clock*/ ctx[0].minute * 6 + ")");
    			add_location(text0, file, 47, 4, 1716);
    			attr_dev(g0, "transform", g0_transform_value = "rotate(" + /*$minuteSpring*/ ctx[6] * 6 + ")");
    			add_location(g0, file, 45, 3, 1617);
    			attr_dev(line3, "y1", "-42");
    			attr_dev(line3, "y2", "-48");
    			set_style(line3, "stroke", "white");
    			add_location(line3, file, 50, 4, 1881);
    			attr_dev(text1, "y", "-30");
    			attr_dev(text1, "x", "-4.5");
    			set_style(text1, "fill", "white");
    			add_location(text1, file, 51, 4, 1932);
    			attr_dev(g1, "transform", g1_transform_value = "rotate(" + /*$hourSpring*/ ctx[7] * 30 + ")");
    			add_location(g1, file, 49, 3, 1834);
    			attr_dev(svg2, "viewBox", "-50 -50 100 100");
    			attr_dev(svg2, "style", "width:25%; height=25%");
    			add_location(svg2, file, 43, 2, 1498);
    			attr_dev(div1, "id", "adjust");
    			attr_dev(div1, "class", "svelte-ctxvck");
    			add_location(div1, file, 30, 1, 695);
    			attr_dev(div2, "class", "svelte-ctxvck");
    			add_location(div2, file, 55, 1, 2024);
    			add_location(h11, file, 62, 3, 2385);
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "max", "23");
    			add_location(input0, file, 63, 3, 2402);
    			add_location(p0, file, 63, 53, 2452);
    			add_location(br0, file, 63, 71, 2470);
    			add_location(h12, file, 64, 3, 2478);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "max", "59");
    			add_location(input1, file, 65, 3, 2497);
    			add_location(p1, file, 65, 56, 2550);
    			add_location(br1, file, 65, 76, 2570);
    			add_location(button0, file, 66, 3, 2578);
    			add_location(br2, file, 66, 112, 2687);
    			attr_dev(button1, "class", button1_class_value = "" + (null_to_empty(/*clock*/ ctx[0].alarmIsActive ? 'checked' : '') + " svelte-ctxvck"));
    			add_location(button1, file, 67, 3, 2695);
    			add_location(br3, file, 67, 145, 2837);
    			add_location(button2, file, 68, 3, 2845);
    			attr_dev(div3, "style", div3_style_value = /*isHidden*/ ctx[3] ? 'visibility: hidden' : '');
    			attr_dev(div3, "class", "svelte-ctxvck");
    			add_location(div3, file, 61, 2, 2329);
    			set_style(button3, "position", "absolute");
    			set_style(button3, "top", "50%");
    			set_style(button3, "right", "1%");
    			add_location(button3, file, 70, 2, 2908);
    			attr_dev(div4, "class", div4_class_value = "" + (null_to_empty(/*isHidden*/ ctx[3] ? 'hidden' : 'shown') + " svelte-ctxvck"));
    			...
    			add_location(div4, file, 60, 1, 2150);
    			attr_dev(main, "class", "svelte-ctxvck");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*clock*/ 1 && text0_transform_value !== (text0_transform_value = "rotate(" + /*clock*/ ctx[0].minute * 6 + ")")) {
    			...
    			if (dirty & /*clock*/ 1 && button1_class_value !== (button1_class_value = "" + (null_to_empty(/*clock*/ ctx[0].alarmIsActive ? 'checked' : '') + " svelte-ctxvck"))) {
    			...
    			if (dirty & /*isHidden*/ 8 && div4_class_value !== (div4_class_value = "" + (null_to_empty(/*isHidden*/ ctx[3] ? 'hidden' : 'shown') + " svelte-ctxvck"))) {
